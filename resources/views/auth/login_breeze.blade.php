        ...
        <div class="max-w-md w-full">
            <div class="register-container" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 20px; padding: 40px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3);">
                <div class="register-header" style="text-align: center; margin-bottom: 40px;">
                    ...
                    <h2 style="color: #ffffff; font-size: 28px; font-weight: 600; margin-bottom: 8px;">Welcome Back</h2>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div style="display: flex; align-items: center; gap: 8px; margin: 20px 0;">
                        ...
                        <label for="remember_me" style="color: rgba(255, 255, 255, 0.9); font-size: 14px; margin: 0;">Remember me</label>
                    </div>
                ...
                <div style="text-align: center; color: rgba(255, 255, 255, 0.8); font-size: 14px;">
                    ...
                    <a href="{{ route('register') }}" style="color: #ffffff; text-decoration: none; font-weight: 600;">Create one here</a>
                </div>
            </div>
        </div>
    </div>
